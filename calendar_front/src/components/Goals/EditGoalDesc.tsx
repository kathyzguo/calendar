...
const EditGoalDesc = ({goalDesc, setGoalDesc, base, goalL, setGoalL, allGoalL, setAllGoalL}: 
    {goalDesc: GoalDesc | undefined, setGoalDesc: (c: GoalDesc | undefined) => void, base: string, 
